...
function spa_and_salon_scripts() {
    ...
    wp_enqueue_style( 'spa-and-salon-woocommerce-style', get_template_directory_uri(). '/css/woocommerce.css', array('spa-and-salon-style'), SPA_AND_SALON_THEME_VERSION );

	wp_enqueue_script( 'flexslider', get_template_directory_uri() . '/js/jquery.flexslider.js', array('jquery'), '2.6.0', true );
    wp_enqueue_script( 'meanmenu', get_template_directory_uri() . '/js/jquery.meanmenu.js', array('jquery'), SPA_AND_SALON_THEME_VERSION, true );
    wp_enqueue_script( 'equal-height', get_template_directory_uri() . '/js/equal-height.js', array('jquery'), SPA_AND_SALON_THEME_VERSION, true );
    wp_enqueue_script( 'mcustomscrollbar', get_template_directory_uri(). '/js/jquery.mCustomScrollbar.js', array('jquery'), SPA_AND_SALON_THEME_VERSION, true  );
	wp_enqueue_script( 'spa-and-salon-js', get_template_directory_uri() . '/js/custom.js', array('jquery'), SPA_AND_SALON_THEME_VERSION, true );
