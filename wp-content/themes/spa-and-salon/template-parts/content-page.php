...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php echo '<div class="post-thumbnail">'; ?>
 		 <?php ( is_active_sidebar( 'right-sidebar' ) && ( $sidebar_layout == 'right-sidebar' ) ) ? the_post_thumbnail( 'spa-and-salon-with-sidebar' ) : the_post_thumbnail( 'spa-and-salon-without-sidebar' ) ; ?>
    <?php echo '</div>' ;?>
		<?php
